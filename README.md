...
```
    pip install pyBKT
```
[LAK pyBKT Tutorial in Google Colab Notebook](https://colab.research.google.com/drive/1Kg6AvXKdSZXoqzSZ5BRHuewyHRMvrZs1?usp=sharing#scrollTo=8vXtO4xCL_7p "pyBKT quick start in Colab") 
